...
function ToggleVehicleLock(vehicle)
	...
	if locked then
        ...
        TriggerEvent("swt_notifications:Icon",Lang['unlock_vehicle'],"top",2500,"green-8","white",false,"mdi-lock-open-variant-outline")
        locked = false
	elseif not locked then
        ...
        TriggerEvent("swt_notifications:Icon",Lang['lock_vehicle'],"top",2500,"orange-8","white",false,"mdi-lock-outline")
        locked = true
	end
